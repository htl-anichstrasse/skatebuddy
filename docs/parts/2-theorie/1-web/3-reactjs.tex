...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{Theorie/React/Renderfunktion.png}
    \caption{Ein kleines Beispiel für eine Renderfunktion in React}
  \end{center}
\end{figure}
...
So würde die Renderfunktion von oben dann auf der Website aussehen.
 ...
 Richtung weitergegeben werden und zwar vom Elternteil zum Kind.

 TODO: Pros read only \cite{Props}
