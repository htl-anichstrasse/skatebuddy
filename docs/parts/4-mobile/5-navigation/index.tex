...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{Mobile/Navigators.png}
    \caption{Stack Navigator und Tab-Navigator}
  \end{center}
\end{figure}

\newpage
\input{parts/4-mobile/5-navigation/0-tabNavigator/index.tex}

\newpage

\input{parts/4-mobile/5-navigation/1-stackNavigator/index.tex}