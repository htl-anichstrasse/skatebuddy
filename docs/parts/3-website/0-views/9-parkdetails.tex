...
In den Details der einzelnen Parks gibt es eine \underline{\nameref{map}} mit zwei Marker zu finden. Ein Marker für die 
...
\begin{figure}[H]
    \begin{center}
      \frame{\includegraphics[width=1\textwidth]{Website/Obstacles.png}}
...
\begin{figure}[H]
  \begin{center}
    \frame{\includegraphics[width=1\textwidth]{Website/Review-Schreiben.png}}
...
\begin{figure}[H]
  \begin{center}
    \frame{\includegraphics[width=1\textwidth]{Website/Review.png}}
